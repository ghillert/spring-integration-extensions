...
/**
 * Parser for the 'outbound-channel-adapter' element of the atmosphere namespace.
 *
 * @author Gunnar Hillert
 * @since 0.5
 *
 */
public class AtmosphereChannelAdapterParser extends
		AbstractOutboundChannelAdapterParser {
	protected AbstractBeanDefinition parseConsumer(Element element,
			ParserContext parserContext) {
		BeanDefinitionBuilder builder = BeanDefinitionBuilder
				.genericBeanDefinition(AtmosphereBroadcastingMessageHandler.class);
		...
		IntegrationNamespaceUtils.setValueIfAttributeDefined(builder, element, "message-threshold");
