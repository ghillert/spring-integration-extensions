...
public class CacheCallerImp{
	...
	public Object putData(Object message){
		return MessageBuilder.withPayload(message).setHeader(CacheOutboundGatewayHeaders.COMMAND,CacheOutboundGatewayHeaders.PUT)
				.build();
	}

	public Object getData(Object message){
		return MessageBuilder.withPayload(message).setHeader(CacheOutboundGatewayHeaders.COMMAND,CacheOutboundGatewayHeaders.GET)
				.build();
	}
