...
import org.springframework.integration.samples.atmosphere.model.StatisticMessage;
import org.springframework.integration.samples.atmosphere.model.TwitterMessage;
import org.springframework.integration.support.MessageBuilder;
import org.springframework.mvc.atmosphere.common.AtmosphereApplicationEvent;
...
public class TweetTransformer {
	...
	public Message<StatisticMessage> transformEvent(Message<AtmosphereApplicationEvent> sourceMessage) {

		final AtmosphereApplicationEvent event = sourceMessage.getPayload();
		...
		destinationTwitterMessage.setSubscriberIds(null);  //FIXME
