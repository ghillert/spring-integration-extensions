...
public class BroadcastMetricsApplicationListener implements
		ApplicationListener<AtmosphereApplicationEvent> {

	private static final Log LOG = LogFactory.getLog(BroadcastMetricsApplicationListener.class);

	@Override
	public void onApplicationEvent(AtmosphereApplicationEvent event) {

		if (LOG.isInfoEnabled()) {
//			LOG.info(String.format("Event: %s; Number of AsynHttp Subscribers: %s.",
