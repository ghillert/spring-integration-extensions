 ...
 */
package org.springframework.integration.samples.atmosphere.model;
...
public class JacksonJsonTest {
	...
	public void testSerializeTwitterMessageToJson() throws Exception {
		...
		final TwitterMessage message1 = new TwitterMessage(1L, getSampleDate(),
				"text", "fromUser", "profileImageUrl");
		final TwitterMessage message2 = new TwitterMessage(1L, getSampleDate(),
				"text", "fromUser", "profileImageUrl");
		...
		final String expectedJson = "[{\"type\":\"TwitterMessage\",\"id\":1,\"createdAt\":1309898277000,\"text\":\"text\",\"fromUser\":\"fromUser\",\"profileImageUrl\":\"profileImageUrl\"},{\"type\":\"TwitterMessage\",\"id\":1,\"createdAt\":1309898277000,\"text\":\"text\",\"fromUser\":\"fromUser\",\"profileImageUrl\":\"profileImageUrl\"}]";
	...
	@Test
	public void testSerializeTwitterMessageToJsonUsingHttpConverter()
			throws Exception {
